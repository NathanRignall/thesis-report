...
%\renewcommand{\includegraphics}[2][]{\fbox{\texttt{[image omitted]}}}
...
\usepackage{booktabs}   % for \toprule, \midrule, \bottomrule, etc.
\usepackage{multirow}   % only if you use \multirow{…}
 \usepackage{array} 
 \usepackage{tabularx}  % only if you want auto-wrapping or special column widths
\usepackage{url}
%\usepackage{placeins}
%\usepackage{float}
  % Required for multi-row cells
  \usepackage{multirow} 
...
\date{June 2025}
\newcommand{\candidatenumber}{9627J}
...
Main chapters word count: 14568
...
gs -q -dSAFER -sDEVICE=txtwrite -o - \
      -dFirstPage=10 -dLastPage=61 report-submission.pdf | \
   egrep '[A-Za-z]{3}' | wc -w
14568
\end{verbatim}
\end{quote}
...
\bigskip 
\textbf{Signed:} \raisebox{-1cm}{\includegraphics[height=2.5cm]{signature.pdf}}

\bigskip
\textbf{Date: 11/06/2025}
\vspace{\fill}
\makeatother\fi
