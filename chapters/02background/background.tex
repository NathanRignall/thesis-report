...
%Attention - \autocite{vaswaniAttentionAllYou2023}.
...
%
%An encoder - \autocite{devlinBERTPretrainingDeep2019}
% Decoder - OpenAI
% Encoder - Decoder https://www.philschmid.de/fine-tune-flan-t5-deepspeed
...
%
Instead of computing a single attention operation, the model splits the Q, K, and V matrices into multiple ``head'', concatenates the outputs 
%
