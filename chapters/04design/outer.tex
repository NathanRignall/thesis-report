...
This resultant layout is then passed to the same \texttt{inner loop} solver as before to calculate the objective, \texttt{rho\_max}.
...
We can expect this method to be significantly faster to execute, as compared to the \textit{direct} approach.
