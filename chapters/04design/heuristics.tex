...
This ensures efficient hardware utilisation and avoids potential performance degradation caused by unaligned memory access or suboptimal parallelism. %CITE
...
Configurations with zero throughput are due to the configuration exceeding the memory capabilities of that island.
...
With a positive integer width, we compute the midpoint offset as \(\mathrm{mid} = \left\lfloor \tfrac{W}{2}\right\rfloor\).
