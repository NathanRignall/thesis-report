...
%	\end{tikzpicture}
%    \caption[Problem formulation demonstrating the data flow between the \textit{inner} and \textit{outer} loop.]
%    {Problem formulation demonstrating the data flow between the \textit{inner} and \textit{outer} loop.}
