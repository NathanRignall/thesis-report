...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{traces_sample_pdfs.pdf}
    \caption[Sample probability distribution of input sequence lengths]
    {Sample probability distribution of input sequence length. Modelled using a pdf where $mu=500$, $sigma=2000$ and truncated/normalised to the range \(0 \leq s \leq 8000\). Average decode length (100) and max decode length (500) are extracted for use in the scheduler.}
