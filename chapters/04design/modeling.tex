...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{traces_prefill_sample.pdf}
    \caption[Sample probability distribution of input sequence lengths]
    {Sample probability distribution of input sequence length. Modelled using a pdf where $mu=500$, $sigma=2000$ and truncated/normalised to the range \(0 \leq s \leq 8000\).}
